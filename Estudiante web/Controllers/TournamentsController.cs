...
namespace Soccer.web.Controllers
{
    ...
    public class TournamentsController : Controller
    {
        ...
        //accion index incluya todos los grupos 
        public async Task<IActionResult> Index()
        {
            return View(await _context
                .Tournaments
                .Include(t => t.Groups) //funcioname como un inner join, incluyame todos los grupos en el torneo
                .OrderBy(t => t.StartDate)// odenado por fecha de inicio 
                .ToListAsync());
        }
